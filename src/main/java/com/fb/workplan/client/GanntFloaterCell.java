...
class GanntFloaterCell implements Cell<TaskWidgetData> {
	...
	public GanntFloaterCell(Date periodStartDate, Date periodEndDate, ChartType type, ElementMapper mapper) {
		if (template == null) {
	...
	public void setValue(Context context, Element parent, TaskWidgetData value) {
		...
		if (coordinatesMapper != null && parent.getFirstChildElement() != null) {
			coordinatesMapper.setElementForValue(parent.getFirstChildElement(), value);
		}
	}
	...
	private ElementMapper coordinatesMapper;
}
